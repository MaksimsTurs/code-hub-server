...
export default function refreshAccessToken(request: Request, response: Response, next: NextFunction): void {
	...
	const [refreshToken, errorByVerifyingToken] = JWT.verifyToken<TJWTAccountToken>(rawRefreshToken, CONFIG_CONST.REFRESH_SECRET!);
